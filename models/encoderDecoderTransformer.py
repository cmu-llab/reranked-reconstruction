# loosely based on Kim et al. (2023) https://github.com/cmu-llab/acl-2023/
...
class EncoderDecoderTransformer(pl.LightningModule):
    ...
    def forward_on_batch(self, batch):
        ...
        logits = self.forward(
            ...
            memory_key_pad_mask = s_pad_mask,
            t_tkns = t_tkns_in,
            t_mask = t_mask,
            t_pad_mask = t_pad_mask,
        )
    ...
    def greedy_decode(self, s_tkns, s_lens, s_langs, s_mask, s_pad_mask, decode_max_len):
        ...
        # region the original unbatched decode
    ...
    def training_step(self, batch, batch_idx):
        ...
        logits, loss = self.forward_on_batch(batch)
    ...
    def shared_eval_step(self, batch, _batch_idx, prefix: str):
        ...
        _logits, loss = self.forward_on_batch(batch)
