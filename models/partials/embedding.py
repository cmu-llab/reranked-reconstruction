# based on Chang et al. (2022) https://github.com/cmu-llab/meloni-2021-reimplementation/blob/main/model.py
# with modifications on language embedding logic for reflex prediction
