...
# used for correlation test and assumes that the d2p model is controlled
...
# res_log_dir = f'reranking_tests/d2p-{D2P_RUN}-p2d-{P2D_RUN}'
# # create res_log_dir if it doesn't exist
